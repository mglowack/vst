...
struct named_type_trait<vst::type<named_type_pod<underlying_t, tag_t, op_categories_t>, ops...>>
{
    ...
    template<typename T>
    static constexpr bool is_transparent_with = type_list_any_v<op_categories, transparent_type_traits<T>::template is_transparent_with_t>;
...
concept TransparentWith = NamedType<T> && T::template is_transparent_with<U>;
